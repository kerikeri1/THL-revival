...
The original ran on a single 1.44MB floppy. Everything in RAM. GPG as the only tool that mattered. Boot, encrypt, shut down, leave no trace. That idea never got old. The floppy did.
